...
#define CASE_LABEL(x) case x: return #x;
	...
	CASE_LABEL(MSG_META_CLEAR_HOTKEY_TEAMS)
	CASE_LABEL(MSG_META_AUTO_GROUP1)
	CASE_LABEL(MSG_META_AUTO_GROUP2)
	CASE_LABEL(MSG_META_AUTO_GROUP3)
	CASE_LABEL(MSG_META_AUTO_GROUP4)
	...
	CASE_LABEL(MSG_META_TOGGLE_SHOW_OBJECTS_UNDERFOG)
	CASE_LABEL(MSG_META_TOGGLE_COLOR_ARMY_POS)
	...
	CASE_LABEL(MSG_CLEAR_HOTKEY_TEAMS)
	CASE_LABEL(MSG_META_FORCE_DESYNC)
